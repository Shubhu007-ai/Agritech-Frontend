...
const Dashboard = () => {
    ...
    const fetchMarketPrices = useCallback(async () => {
        try {
            ...
            return [
                { crop: "Wheat", price: "2125 Rs/Quintal", state: "UP", numericPrice: 2125 },
                { crop: "Rice", price: "3800 Rs/Quintal", state: "Punjab", numericPrice: 3800 },
                { crop: "Cotton", price: "6200 Rs/Quintal", state: "Gujarat", numericPrice: 6200 },
                { crop: "Mustard", price: "5450 Rs/Quintal", state: "Rajasthan", numericPrice: 5450 },
                { crop: "Potato", price: "1100 Rs/Quintal", state: "Agra", numericPrice: 1100 },
            ];
        }
    }, []);
    ...
    const handleSelectCity = (city) => {
        ...
        Promise.all([getWeather(c), getForecast(c), fetchWeatherAlert(c)])
    ...
    const handleGeolocation = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            pos => {
                ...
                Promise.all([getWeather(coords), fetchWeatherAlert(location)])
                    .then(() => setLoading(false));
            },
            () => {
    ...
    const filteredMarket = market.filter(m =>
        (selectedCrop === "All Crops" || m.crop.toLowerCase().includes(selectedCrop.toLowerCase())) &&
        ...
        <>
            ...
            <div className="dash-container">
                                ...
                                <ul className="suggestions-list" ref={suggestionsListRef}>
                                    {suggestions.map((city, i) => (
                                        <li
                                            ...
                                            style={i === activeIndex ? { background: "#f1f8e9", fontWeight: "bold" } : {}}
                                        >
                ...
                <div className="dashboard-grid">
                            ...
                            {weather && (
                                <div className="weather-container">
                                    ...
                                    <div className="weather-details-grid">
                                        <div className="detail-item"><span>💨 {(weather.wind.speed * 3.6).toFixed(1)} km/h</span></div>
                                        <div className="detail-item"><span>💧 {weather.main.humidity}% Humidity</span></div>
                                        <div className="detail-item"><span>☁️ {weather.clouds.all}% Clouds</span></div>
                                        <div className="detail-item">
                                            <span style={{ color: getPm25Color(weather.pm2_5), fontWeight: "bold" }}>
                            ...
                            <div className="forecast-list">
                                {forecast.map((d, i) => (
                                    <div key={i} className="forecast-item">
                                        <p className="forecast-day">{new Date(d.dt * 1000).toLocaleDateString("en-US", { weekday: "short" })}</p>
                    ...
                    <div className="card market-card">
                            ...
                            <div className="custom-dropdown-container" ref={dropdownRef}>
                                ...
                                {dropdownOpen && (
                                    <ul className="custom-dropdown-list">
                                        {["All Crops", "Wheat", "Rice", "Mustard", "Potato", "Tomato", "Maize", "Cotton"].map((crop) => (
                                            <li
                                                key={crop}
                                                onClick={() => {
                        ...
                        <div className="sort-buttons">
                            <button onClick={() => setMarket([...market].sort((a, b) => b.numericPrice - a.numericPrice))} className="sort-btn">
                                Highest Price
                            </button>

                            <button onClick={() => setMarket([...market].sort((a, b) => a.numericPrice - b.numericPrice))} className="sort-btn">
                                Lowest Price
                            </button>
                        </div>
                                ...
                                filteredMarket.map((m, i) => (
                                    <div className="market-item" key={i}>
                                        <div className="market-left">
                                            <p className="crop-name" style={{ color: "#dc5631" }}>{m.crop}</p>
                ...
                <div className="tools-grid">
                    <button className="tool-card" onClick={() => navigate("/disease-detector")}>
                        Disease Detector
                    </button>
                    <button className="tool-card" onClick={() => navigate("/soil-report")}>
                        Soil Report
                    </button>
                    <div
                        className="tool-card"
